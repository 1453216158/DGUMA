...
class GeneralRecommender(AbstractRecommender):
    ...
    """
    def __init__(self, config, train_dataloader,test_dataloader,local_time):
        ...
        self.n_users = train_dataloader.dataset.get_user_num()
        self.n_items = train_dataloader.dataset.get_item_num()
